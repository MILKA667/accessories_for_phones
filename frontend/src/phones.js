...
export const MODELS = {
  apple: [
    { value: "iphone_16", label: "iPhone 16" ,image: "/iphone_16.avif", model: "/models/iphone_16_model.png"},
  ...
  samsung: [
    ...
    { value: "galaxy_s23", label: "Galaxy S23" ,image: "/samsung s23.avif"},
    { value: "galaxy_s24", label: "Galaxy S24" ,image: "/samsung s_24.webp"},
    { value: "galaxy_s25", label: "Galaxy S25" ,image: "/samsung_s25.avif"},
  ],
  xiaomi: [
    { value: "redmi_note_11", label: "Redmi Note 11" },
    { value: "mi_11", label: "Mi 11" },
    { value: "mix_4", label: "Mi Mix 4" },
  ],
};